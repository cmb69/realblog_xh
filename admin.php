...
if (!function_exists('sv') || preg_match('#/plugins/realblog/admin.php#i', $_SERVER['SCRIPT_NAME']))
{
...
// End modify JAT 07/11/2005
    $hjs.="\n".'<script type="text/javascript" src="' . $pth['folder']['plugins'] . $plugin . '/jscalendar/calendar-setup.js"></script>';
    // End added JAT 29/10/2005 //

    if ($action == "delete_realblog" || $action == "add_realblog" || $action == "modify_realblog")
        {
    ...
    $pth['file']['plugin_stylesheet']=$pth['folder']['plugins'] . $plugin . '/css/stylesheet.css';
    $pth['file']['plugin_config']=$pth['folder']['plugins'] . $plugin . '/config/config.php';
    $pth['file']['plugin_language']=$pth['folder']['plugins'] . $plugin . '/languages/' . $sl . '.php';
    $pth['file']['plugin_help']=$pth['folder']['plugins'] . $plugin . '/help/help.htm';
    ...
    if ($admin == '')
        $o.= tag('br')."<div id=\"realblog_version\"><h4>".REALBLOG_VERSION."</h4><p>by <a href=\"http://www.ge-webdesign.de/cmsimplerealblog\" target=\"_blank\">ge-webdesign.de</a> (released: ".$realblog_release.")</p><p>".$realblog_based_on."</p></div>";
    ...
    if ($admin == 'plugin_main' && is_writable($db_path . 'realblog.txt'))
        {
        // Verify date format settings & make correct date format for the datepicker.js script
        $my_date_format1=explode('/', $plugin_tx[$plugin]['date_format']);

        if (count($my_date_format1) > 1) { $date_separator1="/"; }
        else
            {
            $my_date_format1=explode('.', $plugin_tx[$plugin]['date_format']);
        ...
        foreach ($cal_date_format1 as $key
        => $value) { @$cal_format.=($key < count($my_date_format1) - 1) ? $value . $date_separator1 : $value; }
        ...
        $realblog_id=isset($_POST['realblog_id']) ? $_POST['realblog_id'] : @$_GET['realblog_id'];
        $realblog_date=isset($_POST['realblog_date']) ? $_POST['realblog_date'] : @$_GET['realblog_date'];
        $realblog_title=isset($_POST['realblog_title']) ? $_POST['realblog_title'] : @$_GET['realblog_title'];
        $realblog_headline=isset($_POST['realblog_headline']) ? $_POST['realblog_headline'] : @$_GET['realblog_headline'];
        $realblog_story=isset($_POST['realblog_story']) ? $_POST['realblog_story'] : @$_GET['realblog_story'];
        $realblog_frontpage=isset($_POST['realblog_frontpage']) ? $_POST['realblog_frontpage'] : @$_GET['realblog_frontpage'];
        $realblog_rssfeed=isset($_POST['realblog_rssfeed']) ? $_POST['realblog_rssfeed'] : @$_GET['realblog_rssfeed'];
		$realblog_comments=isset($_POST['realblog_comments']) ? $_POST['realblog_comments'] : @$_GET['realblog_comments']; // GE 2010 - 11
        $realblog_startdate=isset($_POST['realblog_startdate']) ? $_POST['realblog_startdate'] : @$_GET['realblog_startdate'];
        $realblog_enddate=isset($_POST['realblog_enddate']) ? $_POST['realblog_enddate'] : @$_GET['realblog_enddate'];
        $realblog_status=isset($_POST['realblog_status']) ? $_POST['realblog_status'] : @$_GET['realblog_status'];
        ...
        $realblogtopics=isset($_POST['realblogtopics']) ? $_POST['realblogtopics'] : @$_GET['realblogtopics'];
        $batchdelete_x=isset($_POST['batchdelete_x']) ? $_POST['batchdelete_x'] : @$_GET['batchdelete_x'];
        $changestatus_x=isset($_POST['changestatus_x']) ? $_POST['changestatus_x'] : @$_GET['changestatus_x'];
        $batchchangestatus=isset($_POST['batchchangestatus'])
            ? $_POST['batchchangestatus'] : @$_GET['batchchangestatus'];
        $new_realblogstatus=isset($_POST['new_realblogstatus']) ? $_POST['new_realblogstatus'] : @$_GET['new_realblogstatus'];
        ...
        if ($do == "add" || $do == "modify")
            {
            $realblog_date               =realblog_make_timestamp_dates($realblog_date);
            ...
            $realblogitem[REALBLOG_STARTDATE]=realblog_make_timestamp_dates($realblog_startdate);
            $realblogitem[REALBLOG_ENDDATE]  =realblog_make_timestamp_dates($realblog_enddate);
            $realblogitem[REALBLOG_STATUS]   =$realblog_status;
            $realblogitem[REALBLOG_RSSFEED]  =$realblog_rssfeed;
			$realblogitem[REALBLOG_COMMENTS] =$realblog_comments; // GE 2010 - 11
        ...
        if ($do == "delete")
            {
            $page=$_SESSION['page'];
            $db->deleteWhere($db_name, new SimpleWhereClause(REALBLOG_ID, '=', $realblog_id), INTEGER_COMPARISON);
        ...
        if ($do == "delselected")
            {
            foreach ($realblogtopics as $key
            => $delrealblog_id) { $db->deleteWhere($db_name, new SimpleWhereClause(REALBLOG_ID, '=', $delrealblog_id),
                                               INTEGER_COMPARISON); }
        ...
        if ($do == "batchchangestatus")
            ...
            if ($new_realblogstatus != '' && ($new_realblogstatus == 0 || $new_realblogstatus == 1 || $new_realblogstatus == 2))
                {
        ...
        if ($action === "plugin_text"||$action==="edit")
            ...
            if (isset($batchdelete_x))
                ...
                if (count($realblogtopics) > 0)
                    ...
                    $o="<div><h4>" . ucfirst(REALBLOG_VERSION) . " : " . $title . "</h4></div>";
                    $o.="<div>&nbsp;</div>";
                    $o.="<form name=\"confirm\" method=\"post\" action=\"" . $sn . "?&amp;" . $plugin
                        . "&amp;admin=plugin_main\">";
                    $o.="<table width=\"100%\"><tbody>";

                    foreach ($realblogtopics as $value
                    => $key) { $o.= tag("input type=\"hidden\" name=\"realblogtopics[]\" value=\"" . $key . "\""); }
...
//                session_register ('page'); // removed in php 5.4
                ...
                if (count($realblogtopics) > 0)
                    ...
                    $o.= tag("input type=\"hidden\" name=\"page\" value=\"" . $page . "\"");
                    $o.= tag("input type=\"hidden\" name=\"do\" value=\"batchchangestatus\"");
                    $o.="<td width=\"100%\"  align=\"center\"><select name=\"new_realblogstatus\"><option value=\"\">"
                        . $plugin_tx[$plugin]['entry_status'] . "</option><option value=\"0\">" . $plugin_tx[$plugin]['readyforpublishing'] . "</option><option value=\"1\">" . $plugin_tx[$plugin]['published'] . "</option><option value=\"2\">" . $plugin_tx[$plugin]['archived'] . "</option></select></td>";
            ...
            if ($filter != "true") { $compClause=NULL; }
            else
                {
                if ($filter1 == 'on' && $filter2 == 'on' && $filter3 == 'on' || $filter1 != 'on' && $filter2 != 'on'
                    && $filter3 != 'on') { $compClause=NULL; }
                ...
                if ($filter1 == 'on' && $filter2 == 'on' && $filter3 != 'on') { $compClause
                    =new OrWhereClause(new SimpleWhereClause(REALBLOG_STATUS, "=", 0, INTEGER_COMPARISON),
                                           new SimpleWhereClause(REALBLOG_STATUS, "=", 1, INTEGER_COMPARISON)); }

                if ($filter1 == 'on' && $filter2 != 'on' && $filter3 == 'on') { $compClause
                    =new OrWhereClause(new SimpleWhereClause(REALBLOG_STATUS, "=", 0, INTEGER_COMPARISON),
                                           new SimpleWhereClause(REALBLOG_STATUS, "=", 2, INTEGER_COMPARISON)); }

                if ($filter1 != 'on' && $filter2 == 'on' && $filter3 == 'on') { $compClause
                    =new OrWhereClause(new SimpleWhereClause(REALBLOG_STATUS, "=", 1, INTEGER_COMPARISON),
                                           new SimpleWhereClause(REALBLOG_STATUS, "=", 2, INTEGER_COMPARISON)); }
                }
            ...
            if ($page_record_limit <= 0) { $page_record_limit=10; }

            if ($page_record_limit >= 50) { $page_record_limit=32; }
            ...
            $o.="<div><h4>" . ucfirst(REALBLOG_VERSION) . " - " . $plugin_tx[$plugin]['story_overview']
                . "</h4></div>";
            ...
            else { $start_index=(($page - 1) * ($page_record_limit)); }
...
// new table layout - GE 2010 - 11
            ...
            for ($record_index=$start_index; $record_index <= $end_index; $record_index++)
                {
                if ($record_index > $db_total_records - 1) { $o
                    .="<tr>
					<td class=\"realblog_table_line\" align=\"center\">&nbsp;</td>
					<td class=\"realblog_table_line\" align=\"center\">&nbsp;</td>
					<td class=\"realblog_table_line\" align=\"center\">&nbsp;</td>
					<td  class=\"realblog_table_line\" align=\"center\">&nbsp;</td>
					<td  class=\"realblog_table_line\" align=\"center\">&nbsp;</td>
            ...
            $tmp=($db_total_records > 0)
                ? "" . $plugin_tx[$plugin]['page_label'] . " : " . $page . " / " . $page_total : "";
            $o.="<div class=\"realblog_paging_block\"><div class=\"realblog_db_info\">" . $plugin_tx[$plugin]['record_count'] . " : "
                . $db_total_records . "</div><div class=\"realblog_page_info\">&nbsp;&nbsp;&nbsp;" . $tmp . "</div>";
            ...
            if ($db_total_records > 0 && $page_total > 1)
                ...
                for ($tt=1; $tt <= $page_total; $tt++)
                    ...
                    $o.="<a href=\"" . $sn . "?&" . $plugin . "&admin=plugin_main&action=plugin_text&page=" . $tt
                        . "&amp;filter1=".$filter1."&amp;filter2=".$filter2."&amp;filter3=".$filter3."&amp;filter=".$filter. "\" title=\"" . $plugin_tx[$plugin]['page_label'] . " " . $tt . "\">[" . $tt . "]</a>" . $separator;
                    }
	...
	<p class="cmsimplecore_warning" style="text-align: center;">' . $plugin_tx['realblog']['message_datafile'] . '</p>';
			}
		}
    }
...
function realblogform ($realblogID = NULL, $action = NULL, $ret_page = 1)
    {
    global $pth, $plugin, $plugin_cf, $plugin_tx, $sn, $db_name, $db_path, $plugin_images_folder, $cf, $tx, $cal_format;
    $db         =new Flatfile();
    $db->datadir=$db_path;
    ...
    switch ($action)
        ...
        case "modify_realblog":
            $title=$plugin_tx[$plugin]['tooltip_modify'] . " [ID: " . $realblogID . "]";

            break;

        case "delete_realblog":
            $title=$plugin_tx[$plugin]['tooltip_delete'] . " [ID: " . $realblogID . "]";
    ...
    if ($action === "modify_realblog" || $action === "delete_realblog")
        ...
        $realblog_date           =date($plugin_tx[$plugin]['date_format'], $record[REALBLOG_DATE]);
        ...
        $realblog_startdate      =date($plugin_tx[$plugin]['date_format'], $record[REALBLOG_STARTDATE]);
        $realblog_enddate        =date($plugin_tx[$plugin]['date_format'], $record[REALBLOG_ENDDATE]);
        $realblog_status         =$record[REALBLOG_STATUS];
        $realblog_rssfeed        =$record[REALBLOG_RSSFEED];
		$realblog_comments       =$record[REALBLOG_COMMENTS]; // GE 2010 - 11
        unset ($status);
        $status[$realblog_status]="selected";
        $checked             =($realblog_frontpage == "on") ? "CHECKED" : "";
        $rsschecked          =($realblog_rssfeed == "on") ? "CHECKED" : "";
		$commentschecked     =($realblog_comments == "on") ? "CHECKED" : ""; // GE 2010 - 11
        }
	...
	{
		$t.=tag("input type=\"text\" name=\"realblog_startdate\" id=\"date2\" value=\"" . $realblog_startdate . "\" size=\"10\" maxlength=\"10\" onfocus=\"this.blur()\"") . "&nbsp;" . tag("img src=\"" . $plugin_images_folder . "btn_calendar.gif\" style=\"margin-left:1px;margin-bottom:-3px;\" id=\"trig_date2\" title=\"" . $plugin_tx[$plugin]['tooltip_datepicker'] . "\" alt=\"\"");
	}
	else
	{
    ...
    $t.="<tr><td colspan=\"5\"><textarea class=\"realblog_story_field\" name=\"realblog_story\" id=\"realblog_story\" rows=\"30\" cols=\"80\">" . htmlspecialchars(@$realblog_story) . "</textarea></td></tr>";
...
function realblog_make_timestamp_dates ($tmpdate = null)
    ...
    foreach ($my_detected_date_format as $key => $value)
        ...
        else { $date_format.=$value; }
        }

    foreach ($cal_date_format as $key => $value) { @$cal_format.=$value; }

    foreach ($regex as $key => $value)
        {
        if ($key < (count($regex) - 1)) { @$regex_format.=$value . $date_separator; }
        else { $regex_format.=$value; }
        }
...
function realblog_dbconfirm ($title, $info, $page)
    ...
    if (!isset($page)) { $page=$_SESSION['page']; }
