<?php // utf-8 Marker: äöü 
	...
	$plugin_cf['realblog']['editor']="";
	$plugin_cf['realblog']['entries_per_page']="6";
	$plugin_cf['realblog']['links_visible']="4";
	$plugin_cf['realblog']['entries_order']="desc";
	$plugin_cf['realblog']['rss_copyright']="CopyRight";
	$plugin_cf['realblog']['rss_editor']="Email adress";
	$plugin_cf['realblog']['rss_encoding']="utf-8";
	$plugin_cf['realblog']['rss_logo']="http:// ... /logo.gif";
	...
	$plugin_cf['realblog']['utf8_marker']="äöü";
